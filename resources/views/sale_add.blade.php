...
@section('content')
    ...
    <ul class="breadcrumb">
        ...
        <li><a href="{{ route('sales') }}">Реализации</a></li>
    ...
    <div class="row" id="doc_header">
        ...
        {!! Form::open(['url' => route('addSale'),'class'=>'form-horizontal','method'=>'POST', 'id'=>'new_doc']) !!}
...
@section('user_script')
    ...
    <script>
        $('.x_panel').hide();
        $('.x_content').hide();
        $("#buhcode :contains('76.06')").attr("selected", "selected");
        ...
        $('#new_pos').click(function(){
            $("#buhcode_id :contains('90.01.2')").attr("selected", "selected");
        });

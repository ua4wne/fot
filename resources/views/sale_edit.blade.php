...
@section('content')
    ...
    <ul class="breadcrumb">
        ...
        <li><a href="{{ route('sales') }}">Авансовые отчеты</a></li>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {!! Form::open(['url' => route('addSalePos'),'id'=>'add_pos','class'=>'form-horizontal','method'=>'POST']) !!}
    ...
    <div class="row" id="doc_header">
        ...
        {!! Form::open(['url' => route('saleEdit',['id'=>$model->id]),'class'=>'form-horizontal','method'=>'POST', 'id'=>'new_doc']) !!}
        ...
        <div class="form-group">
            ...
            <div class="col-xs-8">
                {!! Form::select('contract_id',$contract,$model->contract->name,['class' => 'form-control','required'=>'required','id'=>'contract'])!!}
            </div>
        </div>
